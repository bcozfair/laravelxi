...
<head>
    ...
    <title> {{ $name }} - Active Bootstrap Template </title>
    ...
    <header id="header" class="header d-flex align-items-center sticky-top">
        <div class="container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
            ...
            <nav id="navmenu" class="navmenu">
                <ul>
                    <li><a href="{{ route('index') }}" {{-- ตรวจสอบ Route ที่จะ active --}}
                    ...
                    <li><a href="{{ route('portfolio') }}"
                            class="{{ Route::currentRouteName() === 'portfolio' ? 'active' : '' }}">Portfolio</a></li>
                    <li><a href="{{ route('team') }}"
                            class="{{ Route::currentRouteName() === 'team' ? 'active' : '' }}">Team</a></li>
                    <li><a href="{{ route('blog') }}"
                            class="{{ Route::currentRouteName() === 'blog' ? 'active' : '' }}">Blog</a></li>
