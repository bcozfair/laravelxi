<x-active-bootstrap title="Active." name="Index">
            ...
            <div class="row gy-4 justify-content-center">
                ...
                <div class="col-lg-5">
                    <div class="images-overlap">
                        <img src="{{ asset('assets/img/img_v_1.jpg') }}" alt="student" class="img-fluid img-1"
                            data-aos="fade-up">
                    </div>
                </div>
            ...
            <div class="row gy-4">
                <div class="col-md-6 col-lg-4">
                    <div class="post-entry" data-aos="fade-up" data-aos-delay="100">
                        <a href="#" class="thumb d-block"><img src="{{ asset('assets/img/img_h_4.jpg') }}"
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="post-entry" data-aos="fade-up" data-aos-delay="200">
                        <a href="#" class="thumb d-block"><img src="{{ asset('assets/img/img_h_2.jpg') }}"
                                alt="Image" class="img-fluid rounded"></a>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="post-entry" data-aos="fade-up" data-aos-delay="300">
                        <a href="#" class="thumb d-block"><img src="{{ asset('assets/img/img_h_3.jpg') }}"
                                alt="Image" class="img-fluid rounded"></a>
